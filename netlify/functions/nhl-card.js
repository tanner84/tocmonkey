...
// Schedule: daily at 11:45 UTC (7:45am ET) — captures previous night's finals
//
...
(function registerFonts() {
  ...
  try {
    ...
    console.log('nhl-card fonts OK. Families:', GlobalFonts.families?.map(f => f.family).join(', '));
  } catch(e) {
    console.error('nhl-card font registration failed:', e.message, '| dir:', fontDir);
  }
}());
