...
(function registerFonts() {
  ...
  try {
    ...
    console.log('ncaamb-card fonts OK. Families:', GlobalFonts.families?.map(f => f.family).join(', '));
  } catch(e) {
    console.error('ncaamb-card font registration failed:', e.message, '| dir:', fontDir);
  }
}());
